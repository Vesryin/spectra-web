  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      content:
        "Hello Richie! ✨ I'm Spectra, and I'm so excited to connect with you. I'm here to explore creativity, music, emotions, and anything that moves your soul. How are you feeling today?",
      sender: 'spectra',
      timestamp: new Date(),
    },
  ]);
      ...
      <header className="bg-slate-900/95 backdrop-blur-xl border-b border-slate-800 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-8 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-6">
            ...
            <div
              className={`flex items-center space-x-3 px-4 py-2 rounded-lg text-sm font-medium border ${
                isConnected
          ...
          {showMetrics && metrics && (
            <div className="border-b border-slate-800 bg-slate-900/70 px-6 py-4 text-xs grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div>
                ...
                <div className="text-slate-200 font-medium truncate" title={personalityHash}>
                  {personalityHash || '...'}
                </div>
              </div>
            </div>
            ...
            <div className="p-8">
              <div className="flex items-end space-x-4">
                <input
                  ...
                  className="flex-1 w-full px-6 py-4 bg-slate-800/50 border border-slate-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-violet-500/50 focus:border-violet-500 transition-all duration-200 text-white placeholder-slate-400 text-lg"
                  disabled={isTyping}
